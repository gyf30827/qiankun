...
var frameworkStartedDefer = new _utils.Deferred(); // 如果开启了沙箱模式，但是浏览器不支持 proxy 进行降级处理
...
function start() {
  ...
  var _frameworkConfigurati = frameworkConfiguration,
      ...
      importEntryOpts = (0, _tslib.__rest)(frameworkConfiguration, ["prefetch", "sandbox", "singular", "urlRerouteOnly"]); // 预加载
